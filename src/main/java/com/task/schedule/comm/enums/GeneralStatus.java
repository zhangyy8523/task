...
public enum GeneralStatus {
	...
	public static final String KEY = "general_status";
	...
	private GeneralStatus(Integer code, String name) {
		this.code = code;
		this.name = name;
	}
	
	static {
		Set<GeneralStatus> set = EnumSet.allOf(GeneralStatus.class);
		for(GeneralStatus e : set){
